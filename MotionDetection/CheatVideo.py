...
while True:
    ...
    if status_list[-1] == 1 and status_list[-2]==0:
        timechanged.append(datetime.now())
...
print(status_list)
print(timechanged)
for i in range(0,len(timechanged),2):
    df=df.append({"Start":timechanged[i],"End":timechanged[i+1]},ignore_index=True)

df.to_csv("Timechanged.csv")
